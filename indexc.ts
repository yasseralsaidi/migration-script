...
const userSchema = z.object({
  ...
  commerceId: z.string().optional().nullable(),
  role: z.string().optional(),
  portName: z.string().optional(),
  portName_en: z.string().optional(),
...
const createUser = (userData: User) => {
  return userData.hashedPassword
    ? clerkClient.users.createUser({
        ...
        firstName: userData.name_ar,
        lastName: "",
        passwordDigest: userData.hashedPassword,
        ...
        //   portName: userData.portName,
        //   portName_en: userData.portName_en,
        //   role: userData.role,
        //   phoneNumber: userData.phoneNumber ? userData.phoneNumber : undefined,
        //   portType: userData.portType,
        ...
        createdAt: userData.createdAt
          ...
          : new Date(),
        username: userData.civilId
          ? "uu" + userData.civilId
          : userData.commerceId
          ? "uu" + userData.commerceId
          : userData.username ?? "",
      })
    : clerkClient.users.createUser({
        externalId: userData.id,
